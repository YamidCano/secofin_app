<template>
  <q-card class="q-ma-lg q-pa-lg">
    ...
    <div>
      <q-table flat bordered separator="cell" :rows="arl" :columns="columns" :filter="filter" no-data-label="No se encontraron resultados"
          ...
          <q-tr :props="props">
            ...
            <q-td key="actions" :props="props">
              <div class="q-gutter-sm">
                ...
                <q-btn round outline color="red" icon="mdi-delete" size=sm
                  @click="alertDialog = true; itemId = props.row.id">
