  ...
  <q-card class="q-ma-lg">
    <q-card-section>
      ...
      <div class="row q-mt-md">
        ...
        <div class="col">
          <q-input class="q-px-sm" outlined label="Apellidos empleado" v-model="surname"/>
        </div>
      </div>
      <div class="row q-mt-md">
        <div class="col">
    ...
    <q-card-actions vertical align="right">
      <q-btn flat @click="update">Guardar cambios</q-btn>
    </q-card-actions>
  </q-card>
</template>
<script setup>
...
const update = async () => {
  try {
    ...
    const { data } = await serviceFunctionary.updateFunctionary(requestData);
    console.log(data);
